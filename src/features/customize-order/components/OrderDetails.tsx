  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 text-sm py-4">
      ...
      <div className={commonClass}>
        ...
        <p className={pClass}>{selectedItem?.color_preferences?.primary +"," +selectedItem?.color_preferences?.primary }</p>
      </div>
      <div className={commonClass}>
      ...
      <div className={commonClass}>
        <label>Budget</label>
        <p className={pClass}>{selectedItem.budget}</p>
      </div> 
      <div className={commonClass}>
        <label>Expected Date</label>
        <p className={pClass}>{new Date(selectedItem?.preferred_delivery_date).toLocaleDateString()}</p>
      </div>
      <div className={commonClass}>
